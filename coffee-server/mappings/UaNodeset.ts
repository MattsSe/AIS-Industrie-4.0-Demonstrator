export function UaNodeset() {
  return {
    UaNodeset: UaNodeSetSchema
  };
}
export const UaNodeSetSchema = {
  name: 'UaNodeset',
  ...
  elementInfos: [{
    elementName: 'UANodeSet',
    typeInfo: '.UANodeSet'
  }, {
    elementName: 'UANodeSetChangesStatus',
    typeInfo: '.UANodeSetChangesStatus'
  }, {
    elementName: 'UANodeSetChanges',
...
//   define([], UaNodeset_Module_Factory);
// }
// else {
//   var UaNodeset_Module = UaNodeset_Module_Factory();
//   if (typeof module !== 'undefined' && module.exports) {
//     module.exports.UaNodeset = UaNodeset_Module.UaNodeset;
//   }
//   else {
//     var UaNodeset = UaNodeset_Module.UaNodeset;
//   }
// }
