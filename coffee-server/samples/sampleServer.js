...
// Let's bootstrap an instance of OPCUAServer
var server = new opcua.OPCUAServer({
    port: 4334, // the port of the listening socket of the opcua
    resourcePath: "UA/SampleServer", // this path will be added to the endpoint resource name
    buildInfo : {
        productName: "UAServer1",
        buildNumber: "7658",
...
function post_initialize() {
    ...
    server.start(function() {
        ...
        console.log(" the primary opcua endpoint url is ", endpointUrl );
    });
}
